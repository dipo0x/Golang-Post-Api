...
This is a RESTful API built using Golang, Fiber, Mongo Driver, MongoDB and Reflex. This API is a simple CRUD implementation that get, create, update and delete posts.
...
Ensure that you have Golang and MongoDB installed on your machine. You could use MongoDB cloud atlass.
...
```json
{ "name": "2 Adesiyan", "email": "adesiyan22oladipo@gmail.com", "username": "222wqs", "password": "test1234" }
```
